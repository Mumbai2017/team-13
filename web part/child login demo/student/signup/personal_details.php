...
<div class="div_center">
    ...
    <form id="personal_details" name="personal_details" method="post" class="pure-form pure-form-aligned"
        ...
        <fieldset>
            ...
            <div class="pure-control-group">
                ...
                <input type="text" name="batch" id="batch" maxlength="2" placeholder="Batch" autocomplete="off"
                       required>
            </div>
            <div class="pure-control-group">
            ...
            <div class="pure-control-group">
                ...
                <input type="text" name="f_name" id="f_name" maxlength="15" placeholder="First Name" autocomplete="off"
                       required>
            </div>
            <div class="pure-control-group">
                <label for="m_name">Middle Name</label>
                <input type="text" name="m_name" id="m_name" maxlength="15" placeholder="Middle Name" autocomplete="off"
                       required>
            </div>
            <div class="pure-control-group">
                <label for="l_name">Last Name</label>
                <input type="text" name="l_name" id="l_name" maxlength="15" placeholder="Last Name" autocomplete="off"
                       required>
            </div>
            <div class="pure-control-group">
                <label for="mail_id">E-mail</label>
                <input type="email" name="mail_id" id="mail_id" autocomplete="off" maxlength="25" placeholder="E-mail"
                       required>
            </div>
            <div class="pure-control-group">
                <label for="student_contact">Mobile Number</label>
                <input type="text" name="student_contact" id="student_contact" autocomplete="off"
                       placeholder="Mobile Number" required>
            </div>
            <div class="pure-control-group">
                <label for="parent_contact">Parent' Mobile Number</label>
                <input type="text" name="parent_contact" id="parent_contact" autocomplete="off"
            ...
            <div class="pure-control-group">
                ...
                <textarea name="recent_address" id="recent_address" rows="2" cols="50" maxlength="100"
                          placeholder="Recent Address" autocomplete="off" required></textarea>
            </div>

            <div class="pure-control-group">
                <label for="permanent_address">Permanent Address</label>
                <textarea name="permanent_address" id="permanent_address" rows="2" cols="50" maxlength="100"
                          placeholder="Permanent Address" autocomplete="off" required></textarea>
            </div>
            <div class="pure-control-group">
                <label for="mothertongue">Mothertongue</label>
                <input type="text" name="mothertongue" id="mothertongue" maxlength="15" placeholder="Mothertongue"
