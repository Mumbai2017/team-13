...
<body>
<form action="2_testinput_setpaper_admin.php" method="POST">
    <table name='test_input_table' align="center" cellspacing="10">
        ...
        <tr>
            ...
            <td>
                <?php
                $sql_subjects = "SELECT * FROM course ORDER BY Sem ASC, Subject_code ASC";
...
<script>
    ...
    function populate_question_table() {
        ...
        var str = '<div class="table-responsive"> <table name="questions_table" class="table table-condensed">';
...
//alert (no_questions);
            ...
            for (i = 0; i < no_questions; i++) {
                ...
                str+='<td width="400px" height="200px"><textarea style="width:350px;height:180px;wrap:soft;" name="question_'+i+'"  placeholder="QUESTION '+(i+1)+'"> </textarea></td>';
