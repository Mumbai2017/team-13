...
?>
<br><br>
<form action='class_analysis_admin.php' method='POST' onsubmit="return avg_val();">
<center>
    <table border='1' class="table table-condensed" style="width:60%">
        ...
        <tr>
            ...
            <td>
                <select name="class">
                <?php
                $sql_coursemapping = "SELECT DISTINCT Year, Division FROM coursemapping ORDER BY Year ASC, Division ASC";
                ...
                while($row_coursemapping = mysqli_fetch_array($res_coursemapping))
                {
                    ...
                    echo "<option value='".$year."-".$division."'>".$year." - ".$division."</option>";
                }
                ?>
               </select>
            </td>
